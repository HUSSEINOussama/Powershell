...
Import-Csv -path $file -Delimiter ';' | % { 
  ...
  Try {
    ...
    Requis=($CompPendRen -or $CBSRebootPend -or $WUAURebootReq -or $SCCM -or $PendFileRename) 
      } | Select-Object @SelectSplat | Export-Csv "$WorkDir\Last_Reboot_$Date.csv" -NoClobber -Append -Encoding Default -NoTypeInformation -Delimiter ";"
...
# Envoi des fichiers par mail
    ...
    $anonCredentials = New-Object System.Management.Automation.PSCredential($anonUsername,$anonPassword)
        ...
        # Paramètres du mail
    $smtp = "v-srv-exch2k10.abilways.lan" 
    $to = "Oussama HUSSEIN <ohussein@nelite.com>"
    $from = "Server_Reboot <LP_Reboot@abilways.lan>" 
    ...
    $body += "LP_Reboot."
    $Attachments = "$WorkDir\Last_Reboot_$Date.csv",$ErrorLog,"$WorkDir\Last_Reboot_Log.txt"   
