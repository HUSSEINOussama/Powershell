...
#"C:\Users\adm-ohu\desktop\"
$MoveFolder_Directory = "C:\Users\adm-ohu\desktop\"
$Extract_ListHomedir = "C:\Users\adm-ohu\desktop\"
$COT = '"'
$CountTotal = 0
$Count = 0
...
<#
	...
	$DomainController = "v-srv-dc02.abilways.lan"
	$Domain = "abilways.lan"
	$UserShare = "Users"
...
$Folder = Get-ChildItem "\\v-srv-file01\Abilways\99-Perso" | where {$_ -notlike "*_old"} | where {$_ -notlike "depots*"} | where {$_ -notlike "*lotus*"} | Where-Object{$_.PsISContainer}
...
Foreach($InfoFolder In $Folder){
	...
	$user = Get-ADUser -SamAccountName $InfoFolder.BaseName -service $DomainController
