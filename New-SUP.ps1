...
$UpdateList | Select LocalizedDisplayName,Severity,ArticleID,BulletinID,DatePosted,IsExpired,IsLatest | Export-Csv "MaJ Critiques $NameDate test oussama.csv" -Delimiter ';' -NoTypeInformation -Encoding Default
...
CD "$($SiteCode):"
New-CMSoftwareUpdateGroup -Name " MaJ Critiques $NameDate test oussama" -UpdateId $UL 